...
public class UpgradeDiplomaty implements InventoryProvider {
    ...
    public UpgradeDiplomaty(final Faction f) {
        this.f = f;
    }
    ...
    public void init(final Player p, final InventoryContent contents) {
        ...
        contents.set(0, ClickableItem.empty(new ItemBuilder(Material.LECTERN)
            .name("§7Сейчас : §3"+Relations.getLevelLogo(f.getDiplomatyLevel())+" §7уровень")
            .addLore("")
            .build()));  


        contents.set(2, ClickableItem.empty(new ItemBuilder(Material.ENDER_CHEST)
            .name("§5Требования для уровня §3"+Relations.getLevelLogo(f.getDiplomatyLevel()+1) )
            .addLore("")
        ...
        contents.set(4, ClickableItem.of( new ItemBuilder(Material.LECTERN)
            .unsafeEnchantment(Enchantment.CHANNELING, 0)
            .addFlags(ItemFlag.HIDE_ATTRIBUTES)
            .name("§bРазвить до §3"+Relations.getLevelLogo(f.getDiplomatyLevel()+1) )
            .addLore("")
            .addLore( "§7Вы сможете:" )
