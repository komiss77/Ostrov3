...
//Main.log_ok("updateFactions: "+f.getName());
    ...
    protected static String getDescription (final Faction f) {
        return  "<div class=\"regioninfo\"><div class=\"infowindow\"><span style=\"font-size:120%;\">"+f.getName()+
                        "</span><br /> <span style=\"font-weight:bold;color:#00FFFF\">"+TCUtils.stripColor(f.tagLine)+
                        ...
                        "</span><br /> Уровень: <span style=\"font-weight:bold;color:#B0E0E6\">"+TCUtils.stripColor(Level.getLevelIcon(f.getLevel()))+
    ...
    protected static void drawFactionBaseIcon(final Faction f, final String descr) {
        ...
        //    m.deleteMarker();
        //}
        final String lbl = "база "+f.getName();
...
//info("areaMarker="+areaMarker);
                ...
                areaMarker.setFillStyle(0.35, f.getChatColor().value());//(as.fillopacity, fillcolor 0xFF0000);
