...
//    private final Class<E> cls;
    ...
    public SortedList(final Collection<? extends E> c) {
        Object[] a = c.toArray();
        if ((size = a.length) != 0) {
            if (c.getClass() == SortedList.class) {
                elementData = a;
            } else {
     ...
     */
    private void add(final E e, Object[] elementData, final int s) {
...
//        rangeCheckForAdd(index);
    ...
    private class Itr implements Iterator<E> {
        ...
        public void forEachRemaining(Consumer<? super E> action) {
            ...
            final int size = SortedList.this.size;
            int i = cursor;
            if (i < size) {
                final Object[] es = elementData;
                if (i >= es.length)
    ...
    private static class SubList<E extends Comparable<? super E>> extends AbstractList<E> implements RandomAccess {
        private final SortedList<E> root;
         ...
         */
        public SubList(SortedList<E> root, int fromIndex, int toIndex) {
            this.root = root;
            this.parent = null;
        ...
        public Spliterator<E> spliterator() {
            ...
            return new Spliterator<E>() {
                ...
                public SortedList<E>.ArrayListSpliterator trySplit() {
