...
public class CraftPotionEffectType extends PotionEffectType implements Handleable<MobEffect> {
    ...
    public java.util.Map<org.bukkit.attribute.Attribute, org.bukkit.attribute.AttributeModifier> getEffectAttributes() {
        ...
        this.handle.getAttributeModifiers().forEach((attribute, attributeModifier) -> {
            attributeMap.put(
                org.bukkit.craftbukkit.v1_20_R3.attribute.CraftAttribute.stringToBukkit(attribute.toString()),
                // use zero as amplifier to get the base amount, as it is amount = base * (amplifier + 1)
                org.bukkit.craftbukkit.v1_20_R3.attribute.CraftAttributeInstance.convert(attributeModifier.create(0))
            );
        });
    ...
    public double getAttributeModifierAmount(org.bukkit.attribute.Attribute attribute, int effectAmplifier) {
        ...
        net.minecraft.world.entity.ai.attributes.Attribute nmsAttribute = org.bukkit.craftbukkit.v1_20_R3.attribute.CraftAttribute.bukkitToMinecraft(attribute);
