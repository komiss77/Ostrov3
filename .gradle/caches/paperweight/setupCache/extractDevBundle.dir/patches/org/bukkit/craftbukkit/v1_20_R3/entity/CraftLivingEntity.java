...
public class CraftLivingEntity extends CraftEntity implements LivingEntity {
    ...
    public RayTraceResult rayTraceEntities(int maxDistance, boolean ignoreBlocks) {
        ...
        return rayTrace == null ? null : new org.bukkit.util.RayTraceResult(org.bukkit.craftbukkit.v1_20_R3.util.CraftVector.toBukkit(rayTrace.getLocation()), rayTrace.getEntity().getBukkitEntity());
    }
    ...
    public boolean addPotionEffect(PotionEffect effect, boolean force) {
        ...
        this.getHandle().addEffect(org.bukkit.craftbukkit.v1_20_R3.potion.CraftPotionUtil.fromBukkit(effect), EntityPotionEffectEvent.Cause.PLUGIN); // Paper - Don't ignore icon
        return true;
    }
    ...
    public PotionEffect getPotionEffect(PotionEffectType type) {
        ...
        return (handle == null) ? null : org.bukkit.craftbukkit.v1_20_R3.potion.CraftPotionUtil.toBukkit(handle); // Paper
    }
    ...
    public Collection<PotionEffect> getActivePotionEffects() {
        ...
        for (MobEffectInstance handle : this.getHandle().activeEffects.values()) {
            effects.add(org.bukkit.craftbukkit.v1_20_R3.potion.CraftPotionUtil.toBukkit(handle)); // Paper
        }
        return effects;
    }
    ...
    public void broadcastSlotBreak(org.bukkit.inventory.EquipmentSlot slot) {
        this.getHandle().broadcastBreakEvent(org.bukkit.craftbukkit.v1_20_R3.CraftEquipmentSlot.getNMS(slot));
    }
    ...
    public void broadcastSlotBreak(org.bukkit.inventory.EquipmentSlot slot, Collection<org.bukkit.entity.Player> players) {
        ...
        final net.minecraft.network.protocol.game.ClientboundEntityEventPacket packet = new net.minecraft.network.protocol.game.ClientboundEntityEventPacket(
            this.getHandle(),
            net.minecraft.world.entity.LivingEntity.entityEventForEquipmentBreak(org.bukkit.craftbukkit.v1_20_R3.CraftEquipmentSlot.getNMS(slot))
        );
    ...
    public void damageItemStack(org.bukkit.inventory.EquipmentSlot slot, int amount) {
        final net.minecraft.world.entity.EquipmentSlot nmsSlot = org.bukkit.craftbukkit.v1_20_R3.CraftEquipmentSlot.getNMS(slot);
