...
public class CraftBlock implements Block {
        ...
        if (world.capturedBlockStates.size() > 0) {
            ...
            if (!event.isCancelled()) {
                for (BlockState blockstate : blocks) {
                    ...
                    world.checkCapturedTreeStateForObserverNotify(this.position, (org.bukkit.craftbukkit.v1_20_R3.block.CraftBlockState) blockstate); // Paper - notify observers even if grow failed
                }
            }
        }
    ...
    public org.bukkit.SoundGroup getBlockSoundGroup() {
        return org.bukkit.craftbukkit.v1_20_R3.CraftSoundGroup.getSoundGroup(this.getNMS().getSoundType());
    }
